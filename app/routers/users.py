import uuid
from app.models.models import UserDb, UserRegister, UserOut, UserBase, RefreshRequest, UserStatusUpdate, UserRolEnum, PermissionsUserEnum
...
from app.models.models import UserDb, UserRegister, UserOut, UserBase, RefreshRequest, SubscriptionOut, PaymentType, PaymentOut
...
def authenticate_user(username: str, password: str) -> UserBase | None:
    ...
    if not verify_password(password, user.password):
        return None
    return UserBase(username=user.username, email=user.email, rol=user.rol, permissions=user.permissions, status=user.status)
